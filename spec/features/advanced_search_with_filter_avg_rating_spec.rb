...
feature "advanced search filter with average rating" do
  ...
  background do
    ...
    Fabricate(:comment, video: star_wars_1, rate: 5, content: "awesome movie!!!")
    Fabricate(:comment, video: star_wars_2, rate: 3)
    Fabricate(:comment, video: star_trek,  rate: 4)
    Fabricate(:comment, video: star_trek,  rate: 5)
    refresh_index
    sign_in
